...
function main(){
	...
	document.getElementById("mostrar").onclick = function mostrar(){
		...
		document.getElementById("print").onclick = function print(){
			document.title = document.getElementById("clienteY").innerHTML+" fecha: "+document.getElementById("fechaY").innerHTML;
			window.print();
	}	
	...
	document.getElementById("print22").onclick = function print(){
			document.title = document.getElementById("clienteY").innerHTML+" fecha: "+document.getElementById("fechaY").innerHTML;
			window.print();
	}	

	document.getElementById("modificar22").onclick= function modificar(){
			document.getElementById("formulario").innerHTML = form;
			editar();
			main();
	}
